...
<div class="property-item">
    <a href="{{ $this->url('show',['record'=>$property]) }}" class="img">
        {{-- <img src="{{ asset($property->images->first()->image) }}" alt="Image" class="img-fluid" /> </a> --}}
        <img src="{{ asset($property->medias->first()->getUrl()) }}" alt="Image" class="img-fluid" /> </a>
    ...
    <div class="property-content">
        ...
        <div>
            ...
            <a
                href="{{ $this->url('show',['record'=>$property]) }}"
